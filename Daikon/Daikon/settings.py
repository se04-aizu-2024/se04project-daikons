"""
Django settings for Daikon project.
...
SECRET_KEY = 'django-insecure-qt%b_-&s#d_*sj)bm8uq(302%jl%je)zht^0c@57l-b&2o_6z='
...
WSGI_APPLICATION = 'Daikon.wsgi.application'
